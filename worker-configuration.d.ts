/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv` (hash: 86f00ebc096ba3c4b5ddefe17e11d3f7)
...
interface __BaseEnv_CloudflareEnv {
	...
	CONVERSE_RATE_LIMIT: RateLimit;
	SEARCH_RATE_LIMIT: RateLimit;
	AI: Ai;
	ASSETS: Fetcher;
	CLOUDFLARE_ACCOUNT_ID: string;
	CLOUDFLARE_API_TOKEN: string;
	SIDENOTE_AI_GATEWAY_ID: string;
	SIDENOTE_VECTORIZE_INDEX: string;
	SIDENOTE_ASSESS_SECRET: string;
	...
	R2_S3_BUCKET: string;
	SIDENOTE_SESSION_SECRET: string;
	CASE_COORDINATOR: DurableObjectNamespace<import("./worker/index").CaseCoordinator>;
	REFERENCE_MINTER: DurableObjectNamespace<import("./worker/index").ReferenceMinter>;
	ASSESS: Fetcher /* sidenote-assess */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CaseCoordinator" | "ReferenceMinter";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN" | "SIDENOTE_AI_GATEWAY_ID" | "SIDENOTE_VECTORIZE_INDEX" | "SIDENOTE_ASSESS_SECRET" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "R2_S3_ACCESS_KEY_ID" | "R2_S3_SECRET_ACCESS_KEY" | "R2_S3_ACCOUNT_ID" | "R2_S3_BUCKET" | "SIDENOTE_SESSION_SECRET">> {}
}
